...
#define NumberOfAutomaticGears 3 // <<------- Select 3, 4 or 6 gears! // Relocated to vehicle adjustments!
...
int32_t gearRatio[NumberOfAutomaticGears + 1] = {80, 44, 23, 14, 10}; // GM Turbo HydraMatic 700-R4
