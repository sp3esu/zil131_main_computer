...
volatile int jakeBrakeIdleVolumePercentage = 1; // Adjust the min. volume (usually = 80%)
...
volatile int turboVolumePercentage = 1; // Adjust the turbo volume (usually = 70%)
volatile int turboIdleVolumePercentage = 1; // the turbo volume will be engine rpm dependent (usually = 10%)
...
volatile int chargerVolumePercentage = 1; // Adjust the supercharger volume (usually = 70%)
...
volatile int fanVolumePercentage = 1; // Adjust the fan volume (250% for Tatra 813, else 0%)
